...
public class AngleUtil {
    public static RotationUtil.Rotation getRoationToLookAt(BlockPos targetPos) {
        double deltaX = targetPos.getX() + 0.5 - Armageddon.INSTANCE.getPlayer().posX;
        double deltaY = targetPos.getY() + 0.5 - Armageddon.INSTANCE.getPlayer().posY - 1.62 - 0.08 + 0.5;
        double deltaZ = targetPos.getZ() + 0.5 - Armageddon.INSTANCE.getPlayer().posZ;
